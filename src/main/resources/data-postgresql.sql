...
INSERT INTO users (username, password, role_id, account_expired, account_locked, credentials_expired, enabled) VALUES ('lmarquez', '$2a$10$ZK9Y2UfgLivxy37YPiAQWOLMsujY3XJHkRXGYz4Cv7trCZLPLqudi', 1, false, false, false, true);
-- Usuario gcanas, pass = contrasena456
INSERT INTO users (username, password, role_id, account_expired, account_locked, credentials_expired, enabled) VALUES ('gcanas', '$2a$10$juOXaule5VGy1KogEFCu5eFBSmZ54Wv0x1iIbaN7TpcouueD1epKy', 2, false, false, false, true);
